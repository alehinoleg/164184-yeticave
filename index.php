...
$product_categories = ['boards_and_skis' => 'Доски и лыжи',
                       'mounts' => 'Крепления',
                       'boots' => 'Ботинки',
                       'clothing' => 'Одежда',
...
<main class="container">
    ...
    <section class="lots">
        ...
        <?php foreach ($ad_information as $key => $item): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $item['image_url']; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?= formating_number($item['price']); ?><b class="rub">р</b></span>
                        </div>
